...
mod tests {
    use super::{
        ...
        keymap, lane_clips, lanes_h, marked, menu_at, normalise, panel_h, project_path, push_digit,
        retarget, scrub_due, show_label, source_frames, source_tint, span_partner, start_frac,
