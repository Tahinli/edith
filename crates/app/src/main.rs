...
mod tests {
    use super::{
        ...
        cancels_export, clipboard_after_remove, color_snap, envelope, eq_spectrum, eq_x, eq_y,
        ...
        scrub_due, show_label, silence_rate, source_tint, span_partner, speed_at, start_frac,
