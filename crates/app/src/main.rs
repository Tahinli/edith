...
mod tests {
    ...
    use super::{
        ...
        ZOOM_MAX_SECONDS, ZOOM_MIN_FRAMES, ZOOM_STEP, clock, eta_secs, file_name, file_uri,
        fit_choices, library_rows, live_idx, next_fit, next_resolution, note_progress, px_along,
