...
mod tests {
    use super::{
        ...
        EQ_BANDS_MAX, EQ_FREQ_STEP, EQ_Q_HIGH, EQ_Q_LOW, EQ_Q_STEP, EQ_TICKS, EQ_W_MAX, ESCAPE,
        EXPORT_FIXED_H, EXPORT_ROWS_H, EXPORT_W, FORMATS, Format, HEADER_GAP,
        ...
        clipboard_after_remove, color_snap, containers, envelope, eq_card_w, eq_freq, eq_freq_label,
        eq_spectrum, eq_x, eq_y,
        estimated_mb, export_path, export_settings, format_key, format_line, format_refusal,
        fps_label, frac_along, frac_down, frame_at, histogram, inserted_band, is_bare_modifier,
        is_project,
